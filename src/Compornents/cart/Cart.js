            ...
            {cart?.map(p => <div>
                <div>
                    ...
                    <ul className='grid lg:grid-cols-5 md:grid-cols-2 grid-cols-1 bg-gray-50 border lg:m-10 lg:p-5 m-5 p-3 place-items-center'>
                        ...
                        <div>
                            <Link to='/paymentDetails'><button className='bg-blue-400 px-3 py-2 text-white font-bold m-2'>PAYMENT</button></Link>
                            <button onClick={() => handelDelete(p.id)} className='bg-red-400 px-3 py-2 text-white font-bold'>DELETE</button>
                        </div>
